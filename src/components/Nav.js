...
const Nav = () => {
    ...
    return (
        <header className="w-full text-gray-500 body-font mb-4 shadow-sm">
            ...
            <div className="container mx-auto flex justify-between items-center py-3 px-5">
                ...
                <a href="#link" className="flex flex-shrink-0 title-font font-medium items-center text-gray-900 md:mb-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-white p-2 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                    </svg>
                    <span className="ml-3 text-xl text-indigo-500 font-semibold antialiased">TECKTURT</span>
                </a>
                {/* ::Navbar */}
                <nav className="hidden md:flex flex-wrap items-center justify-center text-base tracking-wide">
                    ...
                    <Link to="/home" className='mr-8 hover:text-indigo-500'>Article</Link>
            ...
            {/* ::MOBILE MENU */}
            {
                ...
                <div className="w-full flex flex-col py-4 px-3 md:hidden bg-gray-50 text-base uppercase text-center font-semibold">
                    <a href="#link" className="block px-3 py-2 rounded-md text-gray-500 hover:text-white hover:bg-indigo-700">About</a>
                    <a href="#link" className="block px-3 py-2 rounded-md text-gray-500 hover:text-white hover:bg-indigo-700">Prices</a>
                    <a href="#link" className="block px-3 py-2 rounded-md text-gray-500 hover:text-white hover:bg-indigo-700">Article</a>
                    <a href="#link" className="block px-3 py-2 rounded-md text-gray-500 hover:text-white hover:bg-indigo-700">Contact</a>
                </div>
            }
        </header >
    )
